        ...
        <div class="container-fluid">
          ...
          <div class="row forms_inner">
            <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 col-xl-7">
              <h1 class="h3  text-gray-800">Gallery</h1>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12">
                          <div class="form-group">
                            ...
                            <span><small>(Only upload jpg, png format)</small></span>
                          </div>
                        </div>
                        ...
                        <div class="col-sm-12 text-center">
                          <button type="submit" class="btn btn-primary text-center">Add Gallery</button>
                        </div>
                      </div>
          ...
          <div class="view_form">
            <div class="row">
              <div class="col-sm-12">
                <h5 class="text-gray-800">View Gallery</h5>
                  <div class="card mb-4 py-3 border-top-primary">
