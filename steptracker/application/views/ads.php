        ...
        <div class="container-fluid">
          ...
          <div class="row forms_inner">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-6">
              <h1 class="h3  text-gray-800">Ads</h1>
                    ...
                    <form class="user">
                      <div class="row">
                        ...
                        <div class="col-sm-12 text-center">
                          <button type="submit" class="btn btn-primary text-center">Add Ads</button>
                        </div>
                      </div>
          ...
          <div class="view_form">
            <div class="row">
              <div class="col-sm-12">
                <h5 class="text-gray-800">View Ads</h5>
                  <div class="card mb-4 py-3 border-top-primary">
                          ...
                          <!-- Nav tabs -->
                            ...
                            <div class="tab-content">
                              <div class="tab-pane container active" id="pending">
                                 <div class="">
                                    <table id="datatable_pending" class="table table-striped table-bordered dt-responsive nowrap"  width="100%">
